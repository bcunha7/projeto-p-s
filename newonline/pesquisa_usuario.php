        ...
        <script>
            $(document).ready(function() {
                ...
                $(".usuario-row").on("click", function() {
                    $(".usuario-row").removeClass("table-clicked-row");
                    $(this).addClass("table-clicked-row");
                });
                $(".usuario-row").on("dblclick", function() {
                    var usuarioId = $(this).data("id");
                    window.location.href = "editar_usuario.php?usu_codigo=" + usuarioId;
                });


                $(".edit-link").on("click", function(e) {
                    e.preventDefault();
                    var clienteId = $(this).closest(".usuario-row").data("id");
                    window.location.href = "editar_usuario.php?usu_codigo=" + usuarioId;
                });
                ...
                document.querySelectorAll(".button-deletar").forEach(function(btn) {
                    ...
                    if (data.sucesso) {
                        ...
                        console.error("Erro ao excluir usuario:", data.mensagem);
                    }
                })
